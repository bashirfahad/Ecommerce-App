    ...
    return Scaffold(
      ...
      drawer: Drawer(backgroundColor: Colors.grey[900],
        ...
        children: [
          Column(
            children: [
              DrawerHeader(child: Image.asset("assets/logo.png",color: Colors.white,)),
              Padding(
              ...
              InkWell(
                onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>MyForm())),
                child: Padding(
                  padding: const EdgeInsets.only(left:25.0,bottom: 25),
                  child: ListTile(
                    leading: Icon(Icons.logout,color: Colors.white,),
                    title: Text("Login or Signup",style: TextStyle(color: Colors.white),),
                  ),
                ),
              ),
            ],
